...
RSpec.describe Manceps::Transport::StreamableHTTP do
  ...
  describe '#request' do
    ...
    it 'raises AuthenticationError on 401' do
      ...
      expect do
        transport.request({ jsonrpc: '2.0', id: 1, method: 'initialize' })
      end.to raise_error(Manceps::AuthenticationError, /401/)
    end
    ...
    it 'raises SessionExpiredError on 404' do
      ...
      end.to raise_error(Manceps::SessionExpiredError, /Session expired/)
    end
    ...
    it 'raises ConnectionError on other 4xx/5xx statuses' do
      ...
      expect do
        transport.request({ jsonrpc: '2.0', id: 1, method: 'tools/list' })
      end.to raise_error(Manceps::ConnectionError, /500/)
    end
  end
  ...
  describe 'defensive error handling' do
    ...
    it 'raises ProtocolError when response body is HTML on 200' do
      ...
      expect do
        transport.request({ jsonrpc: '2.0', id: 1, method: 'initialize' })
      end.to raise_error(Manceps::ProtocolError, /Invalid JSON in response/)
    end
